              ...
              >
                <div className="p-8">
                  ...
                  <Link
                    ...
                    className="block w-full text-center px-4 py-3 sm:py-3.5 bg-[#062b2a] text-white rounded-[1.5rem] font-black text-xs tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl uppercase"
                  >
                    {room.isPublic ? 'Orchestrate Entry' : 'Secure Access'}
                  </Link>
                </div>
              </div>
            ))}
