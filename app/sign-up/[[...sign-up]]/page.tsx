    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f6f2] px-4 font-nanum">
      <div className="w-full max-w-md bg-white rounded-3xl p-8 2xl:p-12 shadow-2xl shadow-black/5 border border-black/5 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-10">
          <h1 className="text-[42px] lg:text-[52px] font-bold text-[#0d2a21] mb-2 leading-none tracking-tighter">Begin your <br/><span className="text-[#10b981]">Journey.</span></h1>
          <p className="text-[#0d2a21]/50 text-sm font-medium mt-4">The infrastructure of influence starts here.</p>
        </div>
