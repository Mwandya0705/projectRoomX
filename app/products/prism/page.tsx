    ...
    <div className="min-h-screen bg-[#f5f6f2] font-sans pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center mb-20 sm:mb-32">
          ...
          <div className="relative aspect-square rounded-[2rem] sm:rounded-[4rem] overflow-hidden bg-gradient-to-br from-[#10b981] to-[#3b82f6] p-6 sm:p-12 shadow-2xl">
        ...
        {/* Comparison Section */}
        <div className="bg-white/50 backdrop-blur-xl rounded-[2rem] sm:rounded-[4rem] p-8 sm:p-16 lg:p-24 border border-white/80 shadow-sm mb-20 sm:mb-32">
          <h2 className="text-3xl sm:text-[52px] font-bold text-[#0d2a21] mb-8 sm:mb-12 font-nanum text-center">Why experts choose Prism</h2>
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            <div className="space-y-6 sm:space-y-8">
              <div className="flex gap-4">
                ...
                <p className="text-base sm:text-lg text-[#0d2a21]/80 leading-relaxed font-satoshi">
