  ...
  return (
    <div className="bg-[#f5f6f2]">
      ...
      >
        ...
        <div className="mt-10">
          {!user ? (
            <Link href="/book-a-demo" className="inline-block px-8 py-3.5 rounded-full bg-emerald-950 text-white font-bold text-xs uppercase tracking-wider hover:bg-[#003c33] transition-all shadow-md hover:scale-105 active:scale-95">
               Get a demo
            </Link>
          ) : (
