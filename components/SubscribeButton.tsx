...
export default function SubscribeButton({ roomId }: SubscribeButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full px-8 py-3 sm:py-3.5 bg-blue-600 text-white rounded-lg text-base sm:text-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
    >
